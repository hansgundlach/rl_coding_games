...
def execution_reward_function(completions, **kwargs):
    ...
    for i, comp in enumerate(completions):
        ...
        elif 'SyntaxError' in execution_result['error'] or 'IndentationError' in execution_result['error']:
        ...
        print(f"Completion {i+1}/{len(completions)}: {status} reward={reward:.1f}, time={execution_result['execution_time']:.2f}s")
