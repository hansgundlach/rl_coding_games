...
class GameTrajectory:
    ...
    def add_move(self, player: str, prompt: str, response: str, position: int, is_valid: bool):
...
def play_self_play_game(model, tokenizer, max_length: int = 256) -> Tuple[GameTrajectory, dict]:
    """
...
dataset = Dataset.from_dict({
    "prompt": [dummy_prompt] * 500  # Smaller dataset since each generates multiple moves
})
